...
def return_postgres_cursor():
	conn_string = "host='laso-or.cmzwr3t5wsym.us-west-2.rds.amazonaws.com' dbname='laso' user='laso_db' password='%s'"
...
def return_sql_alchemy_engine():
	engine = create_engine('postgresql://laso_db:%s@laso-or.cmzwr3t5wsym.us-west-2.rds.amazonaws.com:5432/laso')
	return engine
