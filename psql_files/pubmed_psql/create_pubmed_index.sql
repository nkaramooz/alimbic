...
create index if not exists sentence_tuples_2_journal_pub_month_ind on sentence_tuples_2(journal_pub_month);
...
create index if not exists sentence_annotations_2_journal_pub_month_ind on sentence_annotations_2(journal_pub_month);
...
create index if not exists sentence_concept_arr_2_journal_pub_month_ind on sentence_concept_arr_2(journal_pub_month);
...
create index if not exists abstract_tuples_2_journal_pub_month_ind on abstract_tuples_2(journal_pub_month);
...
create index if not exists abstract_concept_arr_2_journal_pub_month_ind on abstract_concept_arr_2(journal_pub_month);
