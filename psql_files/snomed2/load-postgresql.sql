...
FROM '/Users/LilNimster/Documents/cascade/resources/snomed_files/Terminology/sct2_Concept_Snapshot_US1000124_20200301.txt' 
...
FROM '/Users/LilNimster/Documents/cascade/resources/snomed_files/Terminology/sct2_Description_Snapshot-en_US1000124_20200301.txt'
WITH (FORMAT csv, HEADER true, DELIMITER '	', QUOTE E'\b');

COPY curr_textdefinition_f(id, effectivetime, active, moduleid, conceptid, languagecode, typeid, term, casesignificanceid)
FROM '/Users/LilNimster/Documents/cascade/resources/snomed_files/Terminology/sct2_TextDefinition_Snapshot-en_US1000124_20200301.txt'
WITH (FORMAT csv, HEADER true, DELIMITER '	', QUOTE E'\b');
...
FROM '/Users/LilNimster/Documents/cascade/resources/snomed_files/Terminology/sct2_Relationship_Snapshot_US1000124_20200301.txt'
WITH (FORMAT csv, HEADER true, DELIMITER '	', QUOTE E'\b');
...
FROM '/Users/LilNimster/Documents/cascade/resources/snomed_files/Terminology/sct2_StatedRelationship_Snapshot_US1000124_20200301.txt'
WITH (FORMAT csv, HEADER true, DELIMITER '	', QUOTE E'\b');

COPY curr_langrefset_f(id, effectivetime, active, moduleid, refsetid, referencedcomponentid, acceptabilityid)
FROM '/Users/LilNimster/Documents/cascade/resources/snomed_files/Refset/Language/der2_cRefset_LanguageFull-en_US1000124_20200301.txt'
WITH (FORMAT csv, HEADER true, DELIMITER '	', QUOTE E'\b');

COPY curr_associationrefset_d(id, effectivetime, active, moduleid, refsetid, referencedcomponentid, targetcomponentid)
FROM '/Users/LilNimster/Documents/cascade/resources/snomed_files/Refset/Content/der2_cRefset_LanguageSnapshot-en_US1000124_20200301.txt'
WITH (FORMAT csv, HEADER true, DELIMITER '	', QUOTE E'\b');

COPY curr_simplerefset_f(id, effectivetime, active, moduleid, refsetid, referencedcomponentid)
FROM '/Users/LilNimster/Documents/cascade/resources/snomed_files/Refset/Content/der2_Refset_SimpleSnapshot_US1000124_20200301.txt'
WITH (FORMAT csv, HEADER true, DELIMITER '	', QUOTE E'\b');

COPY curr_attributevaluerefset_f(id, effectivetime, active, moduleid, refsetid, referencedcomponentid, valueid)
FROM '/Users/LilNimster/Documents/cascade/resources/snomed_files/Refset/Content/der2_cRefset_AttributeValueSnapshot_US1000124_20200301.txt'
WITH (FORMAT csv, HEADER true, DELIMITER '	', QUOTE E'\b');

COPY curr_simplemaprefset_f(id, effectivetime, active, moduleid, refsetid,  referencedcomponentid, maptarget)
FROM '/Users/LilNimster/Documents/cascade/resources/snomed_files/Refset/Map/der2_sRefset_SimpleMapSnapshot_US1000124_20200301.txt'
WITH (FORMAT csv, HEADER true, DELIMITER '	', QUOTE E'\b');
...
FROM '/Users/LilNimster/Documents/cascade/resources/snomed_files/Refset/Map/der2_iisssccRefset_ExtendedMapSnapshot_US1000124_20200301.txt'
WITH (FORMAT csv, HEADER true, DELIMITER '	', QUOTE E'\b');
