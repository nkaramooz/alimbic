...
psql -d alimbic -c "\copy snomed2.full_relationship to '/home/nkaramooz/Documents/alimbic/psql_files/snomed2/snomed_manual_tables/full_relationship.txt' DELIMITER E'\t'"
...
psql -d alimbic -c "COPY snomed2.transitive_closure_cid FROM '/home/nkaramooz/Documents/alimbic/psql_files/snomed2/snomed_manual_tables/transitive_closure.txt' DELIMITER E'\t'"
