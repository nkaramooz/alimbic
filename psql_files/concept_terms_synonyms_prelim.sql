...
drop table if exists concept_terms_synonyms_prelim;


create table concept_terms_synonyms_prelim as (
...
select 
	...
	,case 
        when t5.supertypeid = '105590001' then 1
        when t5.supertypeid = '373873005' then 2 
...
insert into concept_terms_synonyms_prelim
	select 
	...
	from annotation.concept_terms_synonyms_prelim t1;

create index if not exists p_syn_reference_conceptid on concept_terms_synonyms_prelim(reference_conceptid);
create index if not exists p_syn_reference_term on concept_terms_synonyms_prelim(reference_term);
create index if not exists p_syn_syn_conceptid on concept_terms_synonyms_prelim(synonym_conceptid);
create index if not exists p_syn_syn_term on concept_terms_synonyms_prelim(synonym_term);